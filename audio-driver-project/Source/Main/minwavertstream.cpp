...
--*/
{
    ...
    if (m_bCapture)
    {
        // VirtuaCam microphone is pass-through: the app feeds bridge packets, and underruns become silence.
    }
...
--*/
{
    ...
    while (ByteDisplacement > 0)
    {
        ...
        VirtuaCamMicBridgeReadAudio(m_pDmaBuffer + bufferOffset, runWrite);
