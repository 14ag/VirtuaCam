...
public:
    ...
    DECLARE_PROPERTY_SET_HANDLER(FrameEx)
    DECLARE_PROPERTY_GET_HANDLER(Status)
    DECLARE_PROPERTY_SET_HANDLER(Connect)
    DECLARE_PROPERTY_SET_HANDLER(Disconnect)
    DECLARE_PROPERTY_SET_HANDLER(PreferredAspect)
    DECLARE_PROPERTY_SET_HANDLER(AllowedAspects)
