...
enum
{
	...
	VIRTUACAM_PROP_STATUS = 3,
	VIRTUACAM_PROP_REGISTER_EVENT = 4,
    VIRTUACAM_PROP_PREFERRED_ASPECT = 5,
    VIRTUACAM_PROP_ALLOWED_ASPECTS = 6
};

enum
{
    VIRTUACAM_ASPECT_16_9 = 0,
    VIRTUACAM_ASPECT_9_16 = 1,
    VIRTUACAM_ASPECT_4_3 = 2,
    VIRTUACAM_ASPECT_3_4 = 3
};
