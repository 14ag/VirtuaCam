...
$artifactDir = if ([string]::IsNullOrWhiteSpace($ArtifactRoot)) { Get-HvArtifactDirectory -ArtifactRoot "test-reports\hyperv-clean-validate" } else { Resolve-HvPath -Path $ArtifactRoot }
