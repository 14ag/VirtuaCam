...
const std::wstring KSPROPERTY_CAMERACONTROL_EXTENDED_PROPERTY_ToString(ULONG value) { return ToString(__KSPROPERTY_CAMERACONTROL_EXTENDED_PROPERTY, sizeof(__KSPROPERTY_CAMERACONTROL_EXTENDED_PROPERTY) / sizeof(DWORDAndNameW), value); }
const std::wstring PROPSETID_VIDCAP_CAMERACONTROL_ToString(ULONG value) { return ToString(__KSPROPERTY_VIDCAP_CAMERACONTROL, sizeof(__KSPROPERTY_VIDCAP_CAMERACONTROL) / sizeof(DWORDAndNameW), value); }
const std::wstring PROPSETID_VIDCAP_VIDEOPROCAMP_ToString(ULONG value) { return ToString(__KSPROPERTY_VIDCAP_VIDEOPROCAMP, sizeof(__KSPROPERTY_VIDCAP_VIDEOPROCAMP) / sizeof(DWORDAndNameW), value); }
const std::wstring KSPROPERTY_CAMERACONTROL_PERFRAMESETTING_PROPERTY_ToString(ULONG value) { return ToString(__KSPROPERTY_CAMERACONTROL_PERFRAMESETTING_PROPERTY, sizeof(__KSPROPERTY_CAMERACONTROL_PERFRAMESETTING_PROPERTY) / sizeof(DWORDAndNameW), value); }
const std::wstring KSPROPERTY_CAMERACONTROL_REGION_OF_INTEREST_ToString(ULONG value) { return ToString(__KSPROPERTY_CAMERACONTROL_REGION_OF_INTEREST, sizeof(__KSPROPERTY_CAMERACONTROL_REGION_OF_INTEREST) / sizeof(DWORDAndNameW), value); }
const std::wstring PROPSETID_VIDCAP_CAMERACONTROL_IMAGE_PIN_CAPABILITY_ToString(ULONG value) { return ToString(__KSPROPERTY_CAMERACONTROL_IMAGE_PIN_CAPABILITY, sizeof(__KSPROPERTY_CAMERACONTROL_IMAGE_PIN_CAPABILITY) / sizeof(DWORDAndNameW), value); }
const std::wstring KSPROPERTY_TOPOLOGY_ToString(ULONG value) { return ToString(__KSPROPERTY_TOPOLOGY, sizeof(__KSPROPERTY_TOPOLOGY) / sizeof(DWORDAndNameW), value); }
const std::wstring KSPROPERTY_PIN_ToString(ULONG value) { return ToString(__KSPROPERTY_PIN, sizeof(__KSPROPERTY_PIN) / sizeof(DWORDAndNameW), value); }
const std::wstring KSPROPSETID_Connection_ToString(ULONG value) { return ToString(__KSPROPERTY_CONNECTION, sizeof(__KSPROPERTY_CONNECTION) / sizeof(DWORDAndNameW), value); }
const std::wstring KSPROPERTY_TYPE_ToString(ULONG value) { return ToString(__KSPROPERTY_TYPE, sizeof(__KSPROPERTY_TYPE) / sizeof(DWORDAndNameW), value, true); }
const std::wstring MF_ATTRIBUTE_TYPE_ToString(MF_ATTRIBUTE_TYPE value) { return ToString(__MF_ATTRIBUTE_TYPE, sizeof(__MF_ATTRIBUTE_TYPE) / sizeof(DWORDAndNameW), value); }
...
const std::wstring VARTYPE_ToString(VARTYPE value)
{
	...
	auto str = ToString(__VARTYPE, sizeof(__VARTYPE) / sizeof(DWORDAndNameW), type);
	if (value & VT_VECTOR)
	{
		str += L" | VT_VECTOR";
	}
